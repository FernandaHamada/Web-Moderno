...
function revendaAutomovel(automovel){
    switch(automovel){
        case "hatch":
...
revendaAutomovel("hatch")
revendaAutomovel("motocicletas")
revendaAutomovel("sedans")
revendaAutomovel("caminhonetes")
revendaAutomovel("caminhão")
