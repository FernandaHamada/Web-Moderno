...
e irá retornar um vetor com o número de vezes que ele bateu seu recorde de maior número de pontos 
...
Exemplo:  String: “10 20 20 8 25 3 0 30 1” Retorno: [3, 7]
 ...
 function avaliacaoPontos(pontuacao){
  let recorde = 0
  let piorPont = 1
  ...
  return [recorde, piorPont]
 }

  console.log(avaliacaoPontos(pontuacao)) // retorna '[ 4, 7 ]'
